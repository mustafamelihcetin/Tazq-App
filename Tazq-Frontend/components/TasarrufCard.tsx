...
import { useBudgetStore, getRecentBudgetEntry, type BudgetType } from '../store/useBudgetStore';
...
import { buildTasarrufPlan, tasarrufTypeLabel, TASARRUF_COLOR } from '../utils/lifeModePlans';
