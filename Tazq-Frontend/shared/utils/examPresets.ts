...
export const EXAM_PRESETS: ExamPreset[] = [
  ...
  {
    id: 'katiplik',
    displayName: 'Zabıt Katipliği & Mübariz Sınavı',
    shortName: 'Katiplik',
    aliases: ['katiplik', 'zabit', 'zabıt', 'zabitkatipligi', 'zabıtkatipliği', 'mübariz', 'adalet', 'klavye'],
    category: 'public',
    defaultDailyMinutes: 90,
    preferredTemplates: ['active-recall', 'sprint', 'deep-work'],
    tipTr: '3 dakikada en az 90 doğru kelime + mevzuat — günlük klavye hız ve doğruluk pratiği hayati.',
    tipEn: 'At least 90 correct words in 3 minutes + legislation — daily typing speed & accuracy drills are key.',
  },
  {
    id: 'kaymakamlik',
    displayName: 'Kaymakam Adaylığı Sınavı',
    shortName: 'Kaymakamlık',
    aliases: ['kaymakamlik', 'kaymakamlık', 'kaymakam', 'mülkiidare'],
    category: 'public',
    defaultDailyMinutes: 180,
    preferredTemplates: ['spaced-repetition', 'deep-work', 'active-recall'],
    tipTr: 'Anayasa, İdare Hukuku ve Türkiye İktisadı ağırlıklı — derin mevzuat okumaları ve aralıklı tekrar.',
    tipEn: 'Constitutional & Admin law heavy — deep legislative reading and spaced repetition.',
  },
  {
    id: 'icra',
    displayName: 'İcra Müdürlüğü & Yardımcılığı',
    shortName: 'İcra Müdürlüğü',
    aliases: ['icra', 'icramudur', 'icramüdürlüğü', 'icramudur yardımcısı'],
    category: 'public',
    defaultDailyMinutes: 120,
    preferredTemplates: ['spaced-repetition', 'active-recall', 'deep-work'],
    tipTr: 'İcra-İflas Hukuku ve HMK ağırlıklı — mevzuat maddeleri ve soru bankası odaklı.',
    tipEn: 'Enforcement & Bankruptcy Law focused — article reading and question bank drills.',
  },
  {
    id: 'smmm',
    displayName: 'SMMM Staja Başlama & Yeterlilik',
    shortName: 'SMMM',
    aliases: ['smmm', 'ymm', 'muhasebe', 'mali müşavirlik', 'stajabaşlama'],
    category: 'graduate',
    defaultDailyMinutes: 120,
    preferredTemplates: ['active-recall', 'spaced-repetition', 'deep-work'],
    tipTr: 'Finansal Muhasebe + Vergi mevzuatı — monografi çözümü ve çıkmış sorular belirleyici.',
    tipEn: 'Financial Accounting + Tax code — monographs and past exam questions matter most.',
  },
  {
    id: 'bekcilik',
    displayName: 'Çarşı ve Mahalle Bekçiliği',
    shortName: 'Bekçilik',
    aliases: ['bekcilik', 'bekçilik', 'bekci', 'mahallebekcisi'],
    category: 'public',
    defaultDailyMinutes: 75,
    preferredTemplates: ['active-recall', 'sprint'],
    tipTr: 'Genel Kültür + Mevzuat + Türkçe — soru bankası çözümü ile hız kazan.',
    tipEn: 'General Knowledge + Legislation + Turkish — build speed with question banks.',
  },
];
