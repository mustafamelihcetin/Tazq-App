...
Bu özellik varsayılan olarak KAPALIDIR ve yalnızca sizin açık izninizle, uygulama ayarlarından etkinleştirilir:
   – Yalnızca "uyku" alışkanlığınızı otomatik işaretlemek amacıyla, Apple Sağlık (iOS) veya Health Connect (Android) üzerindeki uyku süreniz okunur.
...
This feature is OFF by default and is enabled only with your explicit permission from the app settings:
   – Solely to auto-mark your "sleep" habit, your sleep duration from Apple Health (iOS) or Health Connect (Android) is read.
