...
namespace Tazq_Frontend.ViewModels
{
    public partial class HomeViewModel : ObservableObject
    {
        ...
        public HomeViewModel(ApiService apiService, ConnectivityService connectivityService, LocalCacheService cacheService, IHapticService hapticService)
        {
        ...
        [ObservableProperty]
        private string dailyProgressText = "Bugün için harika bir gün!";

        [ObservableProperty]
        private double dailyProgressValue = 0;
        ...
        {
            _hapticService.SelectionChanged();
            ResetTaskExpansions();
        ...
        private void UpdateDailyMetrics()
        {
            ...
            {
                DailyProgressText = "Bugün için planlanan görev yok.";
                DailyProgressValue = 0;
                return;
            }

            int completedToday = todayTasks.Count(t => t.IsCompleted);
            DailyProgressText = $"{todayTasks.Count} görevden {completedToday} tanesi tamamlandı.";
            DailyProgressValue = (double)completedToday / todayTasks.Count;
        }
